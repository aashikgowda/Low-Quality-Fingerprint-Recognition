...
Images{len} = [];
for k = 1:len
Images{k} = imread(fullfile('C:\Users\aashi_000\Documents\MATLAB\Biometric\Fingerprint Enhancement\Probe\', files(k).name));
savdir = 'C:\Users\aashi_000\Documents\MATLAB\Biometric\Fingerprint Enhancement\Probe\';
